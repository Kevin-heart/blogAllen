...
!function (e) {
        ...
        inside: a = {
            ...
            attribute: {
                ...
                inside: {
                    ...
                    value: [n, {pattern: /(=\s*)[-\w\xA0-\uFFFF]+(?=\s*$)/, lookbehind: !0}],
                    operator: /[|~*^$]?=/
                }
            },
            "n-th": [{
    ...
    var r = {pattern: /(\d)(?:%|[a-z]+)/, lookbehind: !0}, i = {pattern: /(^|[^\w.-])-?\d*\.?\d+/, lookbehind: !0};
...
Prism.languages["excel-formula"] = {
    ...
    "function-name": {pattern: /[A-Z]\w*(?=\()/i, alias: "keyword"},
    range: {
        pattern: /\$?(?:[A-Z]+\$?\d+:\$?[A-Z]+\$?\d+|[A-Z]+:\$?[A-Z]+|\d+:\$?\d+)/i,
        alias: "property",
        inside: {operator: /:/, cell: /\$?[A-Z]+\$?\d+/i, column: /\$?[A-Z]+/i, row: /\$?\d+/}
    },
    cell: {pattern: /[A-Z]+\d+|\$[A-Za-z]+\$?\d+|[A-Za-z]+\$\d+/, alias: "property"},
    number: /(?:\b\d+(?:\.\d+)?|\B\.\d+)(?:e[+-]?\d+)?\b/i,
    boolean: /\b(?:TRUE|FALSE)\b/i,
    operator: /[-+*/^%=&,]|<[=>]?|>=?/,
    punctuation: /[[\]();{}|]/
...
!function (e) {
    var t = "(?:\"(?:\"\"|[^\"])*\"(?!\")|'(?:''|[^'])*'(?!'))", a = /\b(?:\d[\da-f]*x|\d+(?:\.\d+)?(?:e[+-]?\d+)?)\b/i,
        ...
        i = {pattern: /(^|\s+)(?:proc\s+\w+|quit|run|data(?!\=))\b/i, alias: "keyword", lookbehind: !0},
        s = [/\/\*[\s\S]*?\*\//, {pattern: /(^\s*|;\s*)\*[^;]*;/m, lookbehind: !0}],
        r = {pattern: RegExp(t), greedy: !0}, o = /[$%@.(){}\[\];,\\]/, l = {pattern: /%?\w+(?=\()/, alias: "keyword"},
        d = {
            function: l,
            ...
            lookbehind: !0,
            alias: "keyword"
        }, m = {pattern: /(^|\s)(?:submit(?:\s+(?:load|parseonly|norun))?|endsubmit)\b/i, lookbehind: !0, alias: "keyword"},
        ...
        "proc-cas": {
            ...
            inside: {
                "statement-var": {
                    ...
                    lookbehind: !0,
                    inside: {statement: {pattern: /^saveresult\s+\S+/i, inside: {keyword: /^(?:saveresult)/i}}, rest: d}
                },
                "cas-actions": g,
                statement: {
...
!function (e) {
    ...
    e.languages.yaml = {
        ...
        boolean: {pattern: n("true|false", "i"), lookbehind: !0, alias: "important"},
        null: {pattern: n("null|~", "i"), lookbehind: !0, alias: "important"},
